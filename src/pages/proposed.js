    ...
    <section id="about" className="block about-block">
      <Container fluid style={{marginTop:"40px"}}>
        <div className="title-holder" style={{color:"#0c71c3"}}>
          ...
          The Emeka Anyimu Initiative (EAI) is committed to advancing an educational revolution aimed at uplifting underprivileged children in Ebonyi State. Our proposed projects focus on empowering public schools and students by providing essential study materials, including textbooks, writing supplies, and other learning resources. We also plan to support teachers through professional training and capacity-building workshops to improve the quality of education delivered in the classroom. In addition, we aim to rehabilitate dilapidated school structures across the state, creating a more conducive and safe learning environment. Through these targeted interventions, EAI seeks to promote equal access to quality education and inspire academic success among students from disadvantaged backgrounds.
          </p>
        </div>
        </div>
...
Recognizing the urgent need for intervention, the Emeka Anyimu Initiative (EAI) has identified Ishiagu High School as a priority in its ongoing mission to improve educational infrastructure across the state. As part of our proposed projects, EAI is committed to renovating the school’s classroom roofs to provide a safer, more conducive learning environment. This renovation will include replacing damaged roofing sheets, reinforcing roof structures, and ensuring proper drainage to prevent future deterioration.
Through this project, EAI aims not only to restore the physical integrity of the school but also to boost student morale, encourage school attendance, and promote academic excellence in a safer and more dignified setting.
 </p>
...
Recognizing the urgent need for intervention, the Emeka Anyimu Initiative (EAI) has identified ugwu junior secondary school as a priority in its ongoing mission to improve educational infrastructure across the state. As part of our proposed projects, EAI is committed to renovating the school’s classroom roofs to provide a safer, more conducive learning environment. This renovation will include replacing damaged roofing sheets, reinforcing roof structures, and ensuring proper drainage to prevent future deterioration.
Through this project, EAI aims not only to restore the physical integrity of the school but also to boost student morale, encourage school attendance, and promote academic excellence in a safer and more dignified setting.
 </p>
          </Col>
        </Row>
