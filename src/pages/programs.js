    ...
    <section id="about" className="block about-block">
      <Container fluid>
        <div className="title-holder">
          <h2>About Us</h2>
          <div className="subtitle">Know More About Emeka Anyimu Initiative</div>
        </div>
        <Row>
          <Col sm={6}>
            <Image src={img1} />
...
Since its inception, the Emeka Anyimu Initiative has made a remarkable impact by reaching over 200 public schools and donating study materials to more than 15,000 students. Through the generous support of donors and volunteers, we continue to expand our reach, one school and one student at a time.
